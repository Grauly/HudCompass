...
public class WaypointListWidget extends ElementListWidget<WaypointListWidget.Entry> {
    ...
    @Environment(EnvType.CLIENT)
    public class WaypointEntry extends grauly.hudcompass.screens.WaypointListWidget.Entry {
    ...
    @Environment(EnvType.CLIENT)
    public abstract static class Entry extends ElementListWidget.Entry<grauly.hudcompass.screens.WaypointListWidget.Entry> {
